...
Edits made by Michael Wojdak: https://github.com/Michael-Wojdak/tda_project/blob/main/generate_code_embeddings.py
...
def __prepare_directory(file_url:str, sub_dir:str, level:str='') -> str:
    '''
    Primary Edit by Michael: added level to args so that directories can be split by granularity
    '''
...
def __save_class(data, file_url:str, sub_dir:str, nested_classes:list[dict]) -> None:
    #so class embeddings will go in separate directoy
...
def __save_method(data, file_url:str, sub_dir:str, nested_classes:list[dict], nested_methods:list[dict]) -> None:
    #so method embeddings will go in separate directory
...
def __save_token(data, file_url:str, sub_dir:str, nested_classes:list[dict], nested_methods:list[dict]) -> None:
    #so token embeddings will go in separate directory
