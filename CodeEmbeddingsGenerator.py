'''
Cynthia Xiong's code embeddings generator
Generates the code analyzed in ExploratoryDataAnalysis.ipynb and TopologicalFeatures.ipynb
Link to original: https://github.com/CynthiaTheGriffin/topology_project/blob/main/CodeEmbeddingsGenerator.py
'''
